...
module.exports = {
	...
	delete: async function msgDelete(chan_id, message_id) {
		...
		if (json) {
			if (json.message == "Impossible d'exécuter une action sur un message système") {
				return 'true'
			}
			...
			message_count++
			console.log(`\x1b[97m[\x1b[95m${message_count}\x1b[97m] \x1b[93m${message_id} \x1b[97ma été \x1b[92msupprimé !\x1b[0m`)
			return 'true'
		}
	}
}